...
CausalSelfAttention: Core attention mechanism with Flash-Attention support.

BrainBlock: Individual Transformer layer including LayerNorm and MLP.

BrainGPT: Full model assembly with embedding and language modeling head.
